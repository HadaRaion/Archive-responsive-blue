...
if(window.location.pathname == '/p05.html' ) {
    $('.site-header__bottom-menu__cat').addClass('current-page');
} else {
    $('.site-header__bottom-menu__cat').removeClass('current-page');
}
...
var bottomMenu = $('.site-header__bottom-menu > div > ul > li');
var p04menu = $('.doc__footer__menu');

if ((bottomMenu).length < 1) {
    p04menu.css("bottom", "0px");
    $('.site-header__bottom-menu').css("display", "none");
} 
